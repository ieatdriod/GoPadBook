 ...
 */
public class LinkCSSTag extends CompositeTag
{
    /**
     ...
     */
    private static final String[] mEnders = new String[] {"LINK", "P", "DIV", "TD", "TR", "FORM", "LI"};

    /**
     * The set of end tag names that indicate the end of this tag.
     */
    private static final String[] mEndTagEnders = new String[] {"LINK","P", "DIV", "TD", "TR", "FORM", "LI", "BODY", "HTML"};
