        ...
        Tag
{
    ...
    private Hashtable cssStyle = null;
    public Hashtable getCSSStyle(){
    	return cssStyle;
    }
    
    public void setCSSStyle(Hashtable cssstyle){
    	this.cssStyle = cssstyle;
    }
    
    private ArrayList csslevel = null;
    public ArrayList getCSSStyleMutilLevel(){
    	return csslevel;
    }
    
    public void setCSSStyleMutilLevel(ArrayList cssArray){
    	csslevel = cssArray;
    }
    	...
    	if ((style != null) || (styleclass != null)){
    		if (style != null){
    			...
    			for (int i=0;i<ss.length;i++){
    				if (ss[i].startsWith(styleName+":")){
    					result = ss[i].substring((styleName+":").length());
    				}
    			}
    		}
    		
    	} else if (this instanceof BodyTag){
    		result =  "";
    	} else {
    		result = this.getParent().getStyle(styleName);
    	}*/
    	if (cssStyle != null){
    		result = (String)cssStyle.get(styleName);
    	} 
